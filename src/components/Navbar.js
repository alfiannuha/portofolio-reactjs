...
export default function Navbar() {
  ...
  return (
    <div className="navbar">
      ...
      {
        showNavbar &&
        <div style={{height: '100vh', backgroundColor: '#282c34', position: 'absolute', width: '100%'}}>
          {/* ITEM LINKS */}
          ...
          {/* MENU NAVBAR */}
          <div style={{height: '60px', width: '370px', display: 'flex', justifyContent: 'space-between', paddingLeft: '20px', paddingRight: '20px', bottom:0, position:'fixed'}}>
            <div style={{ marginLeft: '3%' }}>
              <a href="/">
                <img src={Logo} alt="Logo" style={{ width: '52px', height: '52px' }} />
              </a>
            </div>
            <div onClick={() => handleMenu(true)} style={{ marginTop: '2%' }}>
            <Icon
              path={mdiClose}
              size={1.5}
              onClick={() => handleMenu(false)}
